...
inline typename tools::promote_args<T>::type erf(T z, const Policy& /* pol */)
{
   ...
   BOOST_MATH_INSTRUMENT_CODE("result_type = " << type_id<result_type>().name_demangled());
   BOOST_MATH_INSTRUMENT_CODE("value_type = " << type_id<value_type>().name_demangled());
   BOOST_MATH_INSTRUMENT_CODE("precision_type = " << type_id<precision_type>().name_demangled());
   ...
   BOOST_MATH_INSTRUMENT_CODE("tag_type = " << type_id<tag_type>().name_demangled());
